...
While I was working with one of my <FancyLink linkText="Dash" url="https://plot.ly/products/dash/" company="plotly"/> projects I made use of that to create a `data_loader.py` file. You can view the code <FancyLink linkText="Expensor personal" url="https://github.com/villoro/expensor_personal/tree/4.3.3/src" company="github"/>.
...
<Youtube client:load id="BJ-VvGyQxho" title="Python OOP Tutorial 2: Class Variables" />
