...
### 3. Use Filters to Trigger Only What’s Needed
...
## 🚦 Gate Jobs — One Check to Rule Them All
...
* **Reliability:** Gate jobs ensure PR checks are atomic—pass all or block merge.
