...
date: 2019-11-01
image: "/images/blog/0024-pandas.png"
image_dark: "/images/blog/0024-pandas-dark.png"
tags: ["Python", "Pandas"]
draft: false
---
...
The best source for information are the <FancyLink linkText="Pandas web" url="https://pandas.pydata.org/" company="pandas"/> and the <FancyLink linkText="Pandas documentation" url="https://pandas.pydata.org/pandas-docs/stable/user_guide/index.html" company="pandas"/>.
...
But there are also functions to read almost everything (<FancyLink linkText="Pandas docs" url="https://pandas.pydata.org/pandas-docs/stable/reference/io.html" company="pandas"/>).
...
For example you can export it to `parquet` (a really eficient file format, more info <FancyLink linkText="Storing tables efficiently with Pandas" url="https://villoro.com/blog/storing-tables-efficiently-pandas/"/>).
