...
image_dark: "/images/blog/0028-spark_example-dark.png"
tags: ["Python", "Spark"]
draft: false
---
...
We would use open data from <FancyLink linkText="Catalunya" url="https://en.wikipedia.org/wiki/Catalonia"/>.
...
Two of them are from <FancyLink linkText="Ulldemolins" url="https://en.wikipedia.org/wiki/Ulldemolins"/>, one station that was closed on 2008 and the new one with the code `XD`.
