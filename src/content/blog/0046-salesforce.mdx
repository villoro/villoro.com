...
You can find more information about this approach in <FancyInternalLink slug="self-healing-pipelines"/>.
...
More information about this approach can be found in <FancyInternalLink slug="self-healing-pipelines"/>.
