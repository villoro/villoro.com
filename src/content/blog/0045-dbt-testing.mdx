...
Another situation that you might need to handle different is when you want to run table maintainance operations such as `OPTIMIZE` for <FancyLink linkText="Iceberg" url="https://iceberg.apache.org/" company="iceberg"/>.
