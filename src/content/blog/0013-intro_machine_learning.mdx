...
As a way to help you understand what is ML we will use an example of supervised learning. We will use the [bike sharing data](https://www.kaggle.com/contactprad/bike-share-daily-data) from [kaggle](https://www.kaggle.com).
...
> To follow this post you should be looking at the code from [github](TODO)
...
<div id="plotly_preview_target" style="height: 100%; width: 100%;" class="plotly-graph-div"></div>

> You can use zoom and scroling with this plot. I suggest you view it with a computer or on landscape if you are using a phone.

### 2.3. Selecting the algorithm

In this example we will use Support Vector Regression (SVR). It is an algorithm that is similar to a liniar regression but using a treshold. It is out of the scope of this post to explain how it works but you can read it [here](https://medium.com/coinmonks/support-vector-regression-or-svr-8eb3acf6d0ff).
...
<div id="plotly_predictions_validation" style="height: 100%; width: 100%;" class="plotly-graph-div"></div>
...
<div id="plotly_predictions_test" style="height: 100%; width: 100%;" class="plotly-graph-div"></div>
