...
date: 2019-03-19
image: "/images/blog/0010-airflow.png"
image_dark: "/images/blog/0010-airflow-dark.png"
...
## 1. Why Airflow?
People usually need to execute some tasks periodically. One common solution is to use <FancyLink linkText="Cron" url="https://es.wikipedia.org/wiki/Cron_(Unix)"/> wich is a good solution for simple tasks. But the more tasks you need to schedule the more problems I will have, specially if there are dependencies between one another.
...
You can see <FancyLink linkText="Creating EC2 instances in AWS" url="https://villoro.com/blog/creating-ec2-aws/"/> how to create one.
