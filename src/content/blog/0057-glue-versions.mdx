...
You might wonder why still have around 100 versions per table. That's because:

* We have processes that write hourly to some tables
* The clean up is scheduled to run weekly
* The snapshot was taken some days after the last clean up
