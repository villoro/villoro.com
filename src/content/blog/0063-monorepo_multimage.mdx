...
This is the setup described in <FancyInternalLink slug="fast-python-ecs-with-uv"/>.
...
You can read more about this at <FancyInternalLink slug="github-hooks"/>.
...
Starting with a single workspace and a simple `uv`-based setup (as shown in <FancyInternalLink slug="fast-python-ecs-with-uv"/>) is the most efficient way to bootstrap a project. It keeps complexity low and lets you move fast.
