...
Since there is no Claude desktop app for <FancyLink linkText="Pop!_OS" url="https://system76.com/pop/" company="pop_os"/>, I use <FancyLink linkText="Orca" url="https://github.com/stablyai/orca"/>, an open source desktop app for running CLI agents (Claude Code, Codex, ...) in parallel.
