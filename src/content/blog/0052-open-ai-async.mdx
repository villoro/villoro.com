...
In a previous post (<FancyLink linkText="Process Calls with Open AI" url="https://villoro.com/blog/process-calls-open-ai/" dark="true"/>), we explored how to extract insights from audio recordings using OpenAI models.
