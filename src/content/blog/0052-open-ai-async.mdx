...
We will use <FancyLink linkText="Aiohttp" url="https://github.com/aio-libs/aiohttp" dark="true"/> for the API requests.
...
### 4.2. Calling Chat endpoint

### 4.3. Calling Transcription endpoint
