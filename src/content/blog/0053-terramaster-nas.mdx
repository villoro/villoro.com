...
I recently bought the <FancyLink linkText="Terramster F2-424" url="https://amzn.to/40CRZqJ" company="amazon"/> NAS and I wanted to write down all the steps I took for setting it up.
This will help me resinstall everything if I needed and it might help others as well.

## 1. About the hardware

In case anyone is thinking about buying one, here is how it went for me.

### 1.1. The NAS

I previously had a synology D115J but the CPU it had was quite slow.
I wanted my nas to be able to host multiple dockers and for that I needed something more powerful.
After looking for different models, I saw that the cheap models from both Synology and QNAP had pretty outdated CPUs.
Here is where I found out about Terramaster newest NAS.
Initially I was afraid about Terramaster Operative System (TOS) but I read that it was easy to switch it for unraid, Truenas or any other OS I wanted.

Finally, I decided it was better for me to have as fewer disks as possible but as big as I needed them.
So I settled for a 2 bay NAS, the <FancyLink linkText="Terramster F2-424" url="https://amzn.to/40CRZqJ" company="amazon"/>

### 1.2. The Hard Drives

I knew it was important to have disks rated for 24/7 usage and/or tagged for a NAS.
Initially I went for a <FancyLink linkText="Seagate Exos X18 3.5 16TB" url="https://amzn.to/3O2h2vX" company="amazon"/> since they were quite cheap for me but it was a big mistake.
I have my NAS in a closed next to my living room, and those HDD were loud enough to be anyoing.
Fortunatelly I was able to echange them for the <FancyLink linkText="Seagate IronWolf Pro 3.5 NAS 16TB" url="https://amzn.to/4eopD6G" company="amazon"/> (for an extra 90€ per disk) but I think it was worth it, since they are way more silent.

### 1.3. The UPS

Finally I wanted a UPS to make sure a power outage didn't break the NAS.
For me it was important that it had USB connection so that the UPS could automatically turn of the NAS.
I choose the <FancyLink linkText="Master Power (UPS 650 VA - 360W)" url="https://amzn.to/3YDj7Dw" company="amazon"/> since it is a really cheap option as long as you use it a device with low power needs, such as the NAS I chose.
