...
meta_title: Setting UP Terramster NAS
description: xx
date: 2024-10-24
...
#### 5.3.1. Set the NAS as an exit node
...
Finally you can set the NAS as an exit node with:
...
<Notice type="warning">
  You might need to reboot the nas if `tailscale` command is not found.
</Notice>
