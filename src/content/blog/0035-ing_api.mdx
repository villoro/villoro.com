...
> [!info]
> eIDAS certificates can only be obtained by organizations, not by individuals like you or me

This post focus on the **Open Banking** API.

> [!danger]
> **DISCLAIMER:** At the time of writing it is not possible to use "Open Banking" for personal use.
