...
If you need to set up **Poetry**, see: <FancyLink linkText="Poetry python package manager" url="https://villoro.com/blog/poetry-python-package-manager"/>
...
It assumes you follow <FancyLink linkText="Semver" url="https://semver.org/" company="default"/> for the versioning of the project.

<Notice type="warning">
  If you are not following <FancyLink linkText="Semver" url="https://semver.org/" company="default"/>, you probably should since it's the standard.
</Notice>
