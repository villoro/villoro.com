...
FILE_GA_KEY = ""  # path to the key file
PROFILE = ""  # profile ID
...
And the last function is for retrieving all old data. This is meant to only be used the first time.
...
For other SQL engines check the <FancyInternalLink slug="sql-alchemy-python"/>.
...
def insert_into_mysql(df, tablename, cols_id=None, engine=None):
    """
        ...
        Args:
            ...
            cols_id:    allow dropping duplicates using those columns instead of deleting all
