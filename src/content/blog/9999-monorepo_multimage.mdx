...
### 4.4 Failing the PR if Tests Fail

We use an aggregate step (`pytest_gate`) that waits for all matrix jobs and fails if any fail. This guarantees all packages pass before merging.
