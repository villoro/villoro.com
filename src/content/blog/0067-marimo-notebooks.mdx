...
If you want to get a feel for it, the <FancyLink linkText="marimo gallery" url="https://marimo.io/gallery"/> has some very nice examples.
...
I already explained the underlying recovery logic in <FancyInternalLink slug="recover-s3-files-delete-markers"/>, so here I only want to focus on why marimo is a good fit for the interface.
