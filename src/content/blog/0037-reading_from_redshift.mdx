...
<FancyLink
  linkText="SQL Alchemy with python"
  url="https://villoro.com/blog/sql-alchemy-python"
/>
...
<FancyLink
  linkText="Storing tables efficiently with Pandas"
  url="https://villoro.com/blog/storing-tables-efficiently-pandas"
/>
