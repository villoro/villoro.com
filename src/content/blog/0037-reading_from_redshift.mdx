...
date: 2021-06-08
image: "/images/blog/0037-reading_from_redshift.png"
image_dark: "/images/blog/0037-reading_from_redshift-dark.png"
tags: ["Python", "DE", "SQL"]
draft: false
---
...
As an example this can be done with **SQL alchemy**: <FancyLink linkText="SQL Alchemy with python" url="https://villoro.com/blog/sql-alchemy-python"/>
...
As usual, the suggestion is to use **parquet** for storing columnar data. More info here: <FancyLink linkText="Storing tables efficiently with Pandas" url="https://villoro.com/blog/storing-tables-efficiently-pandas"/>
...
With the release of <FancyLink linkText="Pyarrow 3.0.0" url="https://arrow.apache.org/release/3.0.0.html" company="arrow"/> (released on 2021-01-26) a new way of reading parquets was introduced.
...
You can find more info about how parquet files are written in <FancyLink linkText="How Parquet Files are Written" url="http://cloudsqale.com/2020/05/29/how-parquet-files-are-written-row-groups-pages-required-memory-and-flush-operations/" company="default"/>.
