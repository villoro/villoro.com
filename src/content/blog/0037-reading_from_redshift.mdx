...
<Notice type="info">
  POST: [SQL Alchemy with python](https://villoro.com/blog/sql-alchemy-python)
</Notice>
...
<Notice type="info">
  POST: [Storing tables efficiently with Pandas](https://villoro.com/blog/storing-tables-efficiently-pandas)
</Notice>
