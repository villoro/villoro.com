...
If you're just starting with your TerraMaster NAS, I recommend checking out my previous post <FancyInternalLink slug="setting-up-terramaster-nas"/>, where I cover the basics to get your device up and running. Once your NAS is set up, this guide will help you extend its functionality with MEGASync.
...
docker run -d \
  ...
  --volume "/home/<admin_username>/docker/mega/<username>:/megasync/config" \
