...
- **Configuration Files**: `/home/<admin_username>/docker/mega/<username>`  
  This path organizes MEGASync configurations under a dedicated `docker` folder, keeping the structure clean and consistent with other apps.

- **Synced Data**: `/home/<username>`  
  Using the root directory of the target user ensures straightforward access and avoids conflicts with other applications.
...
Advanced container settings:
  Volumes:
    - container: /megasync/config
      type: bind
      host: /home/<admin_username>/docker/mega/villoro
    - container: /sync-data
      type: bind
      host: /home/villoro
  Env:
...
You can also test if the problem you are expecting is related to permissions by giving 777 to the data path.
