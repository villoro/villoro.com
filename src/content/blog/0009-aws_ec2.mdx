...
You can access your instance through an SSH connection. I suggest using the open source <FancyLink linkText="PuTTY" url="https://www.putty.org/" company="default"/>.
