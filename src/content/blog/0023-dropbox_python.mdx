...
date: 2019-09-14
image: "/images/blog/0023-dropbox_logo.jpg"
...
Unfortunatelly it is not possible to dump a `csv` directly with **Pandas** into a `StringIO` at this time (More info: <FancyLink linkText="Pandas issue 22555" url="https://github.com/pandas-dev/pandas/issues/22555"/>)
