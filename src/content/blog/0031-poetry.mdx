...
> [!danger]
> **DISCLAIMER:** A lot has changed since I wrote this. Even though `Poetry` still works, I suggest using `uv` instead. See <FancyInternalLink slug="astral-tools-uv-and-ruff"/>. I'm keeping this here for reference.
...
Poetry has more ways of specifying the versions of the dependencies.
The default one is:
...
Which translates to `>=0.25.0 <1.0.0`
