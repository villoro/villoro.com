...
2. <FancyLink linkText="Solving dependency management in Python with Poetry" url="https://towardsdatascience.com/solving-dependency-management-in-python-with-poetry-165b92069e9d" company="medium"/>
