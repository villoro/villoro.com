...
Initially, I used <FancyLink linkText="Airflow" url="https://airflow.apache.org/" company="airflow"/> (see how in <FancyInternalLink slug="setting-up-airflow"/>) since it was the industry standard at the time.
However, I found Airflow to be overly complex for my needs. This led me to switch to <FancyLink linkText="Luigi" url="https://github.com/spotify/luigi" dark="true"/> (see how in <FancyInternalLink slug="luigi-orchestrator"/>).
...
If you want to do so you can read how in <FancyInternalLink slug="prefect-server-setup-configuration-deployment"/>.
...
<img
  src={prefectDeploymentsParams.src}
  alt="Create Prefect Work Pool"
...
In order to see how to create the `Deployments` themselves, read <FancyInternalLink slug="prefect-server-setup-configuration-deployment" anchor="2-deployments"/>
...
To see how to schedule `flows`, go to <FancyInternalLink slug="prefect-server-setup-configuration-deployment" anchor="2-deployments"/>
