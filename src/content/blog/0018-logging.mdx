...
<Notice type="danger">
  **Disclaimer:** A lot has changed since I wrote this. Right now I wouldn't recommed you to follow my steps.
  Instead I'd suggest you use something like <FancyLink linkText="Loguru" url="https://github.com/Delgan/loguru" dark="true"/>. I'll still keep this here for the record.
</Notice>
