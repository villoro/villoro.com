...
> [!danger]
> **DISCLAIMER:** A lot has changed since I wrote this. Even though this still works, I suggest using `uv` instead. See <FancyInternalLink slug="astral-tools-uv-and-ruff"/>. I'm keeping this here for reference.
