...
> [!danger]
> **DISCLAIMER:** A lot has changed since I wrote this. Even though `black` still works, I suggest using `ruff` instead. See <FancyInternalLink slug="astral-tools-uv-and-ruff"/>. I'm keeping this here for reference.
...
3. Write `Package Control: Install Package`
4. Find `sublack`
...
> [!warning]
> If you are unable to modify the file, copy its contents and save it in a new file in the same location (you can see the location at the top of sublime).
