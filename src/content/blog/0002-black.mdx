...
<FancyLink linkText="Black" url="https://github.com/ambv/black" company="github"/> is a python code formatter that allows developers to focus on code itself. You can try it online [here](https://black.now.sh/).
