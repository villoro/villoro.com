...
To do so I create a simple module <FancyLink linkText="Vpalette" url="https://github.com/villoro/vpalette" dark="true"/> that allows me to call the colors I want to use with an array of color names and indexes. For example:
