...
date: 2019-02-16
image: "/images/blog/0004-material_colors.svg"
...
<div class="w3-center">
  <img src="/static/images/posts/material_colors.svg" alt="material_colors" class="w3-image w3-padding-16"/>
</div>

This allows us to use gradients of the same colors like in the following plot:

<div id="plotly_plot" style="height: 100%; width: 100%;" class="plotly-graph-div"></div>
...
<div class="w3-center">
  <img src="/static/images/posts/flat_colors.svg" alt="flat_colors" class="w3-image w3-padding-16"/>
</div>
...
<script type="module" src="/js/plots/acquisitions.js"></script>
