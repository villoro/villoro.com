...
For more details, see the <FancyLink linkText="Official AWS documentation on S3 Versioning" url="https://docs.aws.amazon.com/AmazonS3/latest/userguide/Versioning.html" company="aws"/>.
...
<Notice type="info">
  If you want, I can add a short CloudTrail + Athena query to list deleted keys in a window, useful when Versioning wasn’t enabled.
</Notice>
