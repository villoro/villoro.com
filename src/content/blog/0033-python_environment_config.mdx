...
date: 2020-05-20
image: "/images/blog/0033-python_config.jpg"
tags: ["Python", "Tools"]
draft: false
---
...
* <FancyLink linkText="Github" url="https://github.com/"/>
...
There are some methodologies that you can follow when working with **GIT**, my suggestion is that you use **gitflow**: <FancyLink linkText="Using gitflow for code control" url="https://villoro.com/blog/using-gitflow"/>
...
My personal favorite is **cmder**: <FancyLink linkText="Cmder terminal for windows" url="https://villoro.com/blog/cmder-terminal-windows"/>
...
The more secure one is by setting up a **SSH** key: <FancyLink linkText="Using git with SSH" url="https://villoro.com/blog/git-with-ssh"/>
...
As an example you can use `black` with `sublack` for **Sublime Text**: <FancyLink linkText="Black for code formatting" url="https://villoro.com/blog/black-code-formatting"/>
...
* <FancyLink linkText="Virtualenv" url="https://virtualenv.pypa.io/en/latest/" company="default"/>
...
You can read more about it here: <FancyLink linkText="Poetry package manager" url="https://villoro.com/blog/poetry-python-package-manager"/>

## 6. Pre-commit

[Git Hooks](https://git-scm.com/book/en/v2/Customizing-Git-Git-Hooks) are a good way to automate some tasks.
There are multiple way of using them. What I suggest is that you use `pre-commit`: <FancyLink linkText="Using Pre-commit to automate tasks" url="https://villoro.com/blog/pre-commit"/>
...
* <FancyLink linkText="Circle CI" url="https://circleci.com/"/>
