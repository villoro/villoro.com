...
<Notice type="info">
  POST: [Using gitflow for code control](https://villoro.com/blog/using-gitflow)
</Notice>
...
<Notice type="info">
  POST: [Cmder terminal for windows](https://villoro.com/blog/cmder-terminal-windows)
</Notice>
...
<Notice type="info">
  POST: [Using git with SSH](https://villoro.com/blog/git-with-ssh)
</Notice>
...
<Notice type="info">
  POST: [Black for code formatting](https://villoro.com/blog/black-code-formatting)
</Notice>
...
<Notice type="info">
  POST: [Poetry package manager](https://villoro.com/blog/poetry-python-package-manager)
</Notice>
...
<Notice type="info">
  POST: [Using Pre-commit to automate tasks](https://villoro.com/blog/pre-commit)
</Notice>
