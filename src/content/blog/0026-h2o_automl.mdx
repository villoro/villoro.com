...
It uses MapReduce to break down tasks so that it can send tasks to workers on a cluster.
...
**AutoML** models are usually faster to train and some of them perform better than the manual ones.
