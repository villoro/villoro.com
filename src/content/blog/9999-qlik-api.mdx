...
<Notice type="info" className="mt-6">
  You can reuse `_check_uuid` for other endpoints (e.g., reloads, automations) by passing named arguments: `self._check_uuid(reload_id=rid)`.
</Notice>

## 5. Triggering reloads with post
