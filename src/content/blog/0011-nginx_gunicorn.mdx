...
## 1. Basic schema
First of all you will need a Linux machine. I'd suggest you use an **AWS EC2** instance. You can see <FancyLink linkText="Creating EC2 instances in AWS" url="https://villoro.com/blog/creating-ec2-aws/"/> how to create one.
...
### 1.4. Supervisor
<FancyLink linkText="Supervisor" url="http://supervisord.org/" company="default"/> is a system that allows users to monitor and control processes. This will make sure to restart the gunicorn process if it anything goes wrong. Without it you should do it yourself.
