...
## Basic schema
First of all you will need a Linux machine. I'd suggest you use an **AWS EC2** instance. You can see <FancyInternalLink slug="creating-ec2-aws"/> how to create one.
...
You will create a config file for your project, for example `/etc/supervisor/conf.d/flask_test.conf`:
...
It is normal to encounter difficulties but I was able to sort it out, you can do it too!
