...
For example, I have a job that transcribes audios (see <FancyInternalLink slug="transcribe-audios-whisper-extract-structured-data-chatgpt"/>).
...
I already described this in a previous post. You can read it at <FancyInternalLink slug="running-dbt-with-aws-ecs-fargate" anchor="82-dbt-run-results"/>.
