...
I already described this in a previous post. You can read it at <FancyLink linkText="Running dbt with AWS ECS (Fargate) | 8.2. dbt run results" url="https://villoro.com/blog/running-dbt-with-aws-ecs-fargate/#dbt-run-results" dark="true"/>.
