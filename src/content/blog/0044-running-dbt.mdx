...
Here, I set up the connection to `prefect` (more info at <FancyInternalLink slug="prefect-server-setup-configuration-deployment" anchor="31-connect-docker"/>).
...
> [!note]
> Remember that you need to connect to Prefect. For more information, visit <FancyInternalLink slug="prefect-server-setup-configuration-deployment" anchor="31-connect-docker"/>
