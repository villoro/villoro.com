...
In this example I'm using <FancyInternalLink slug="poetry-python-package-manager"/> since I think it's better than regular `pip`.
...
You might want to read <FancyInternalLink slug="managing-package-versions-with-poetry"/> for more information about how to manage versions with Poetry.
...
If you are not familiar with Prefect I suggest you read <FancyInternalLink slug="prefect-essentials-setup-and-migration"/> first.

Also make sure you connect EMR to Prefect by following <FancyInternalLink slug="prefect-server-setup-configuration-deployment" anchor="32-connect-emr"/>.
