  ...
  (async function () {
    ...
    const data_duckdb_improvements = {
      labels: [
        ...
        "0.9.0", "0.9.1", "0.9.2", "0.10.0", "0.10.1", "0.10.2", "0.10.3", "1.0.0", "1.0.1-dev1125",
      ],
      datasets: [
        {
          ...
          data: [
            ...
            14.237, 14.015, 13.714, 13.692, 13.356, 13.459, 13.934, 13.8, 13.723
          ],
          pointRadius: 1
        },
        {
          ...
          data: [
            ...
            10.873, 10.612, 10.937, 11.119, 5.863, 5.931, 5.986, 5.85
          ],
          pointRadius: 1
        },
        {
          ...
          data: [
            ...
            7.692, 7.694, 5.413, 5.419, 5.428, 5.44, 5.429, 5.493
          ],
          pointRadius: 1
        },
        {
          ...
          data: [
            ...
            6.128, 6.231, 4.941, 5.03, 5.096, 5.358, 5.42, 5.532
          ],
          pointRadius: 1
        },
        {
          ...
          data: [
            ...
            0.014, 0.015, 0.016, 0.014, 0.014, 0.016, 0.014
          ],
          pointRadius: 1
        },
        {
          ...
          data: [
            ...
            2.446, 2.107, 2.092, 2.08, 2.107, 2.147, 2.117
          ],
          pointRadius: 1
        }
      ]
